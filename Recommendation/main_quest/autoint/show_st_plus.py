...
def load_data():
    ...
    # 하이퍼 파라미터 변경 사항 입력 ##########################
    dropout = 0.4 # dropout, model 정의 (하이퍼파라미터 최적화 값)
    embed_dim = 16 # embed_dim, model 정의 (하이퍼파라미터 최적화 값)
    hidden_units = 32 # hidden_units, model 정의 (하이퍼파라미터 최적화 값)
    batch_size = 2048 # batch_size, model 정의 (하이퍼파라미터 최적화 값)
    ##########################################################
